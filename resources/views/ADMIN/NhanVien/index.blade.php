...
<div class="container-hienthi">
    ...
    <div class="control-search">
        <form class="form_control-search" action="{{ route('ADMIN.nhanvien.index') }}" method="GET">
            ...
            <tr>
                ...
                <td>
                    <button id="btn_sua" style="width: 100%; height:100%;">
                        <a href="{{route('nhanvien.edit',$t['MaNhanVien'])}}">
                ...
                <td>
                    <a onclick="return confirm('Bạn có chắc muốn xoá thông tin này ko?')" href="/admin/nhanvien/{{$t['MaNhanVien']}}/del">
                        <button id="btn_sua" style="width: 100%; height: 100%;">
